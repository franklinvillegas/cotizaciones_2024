                        ...
                        <nav class="bd-links collapse" id="bd-docs-nav">
                            <div class="bd-toc-item">
                               <ul class="list-unstyled ps-0" style="font-size:20px;">
                                    ...
                                    <li class="mb-1" >
                                        <a class="nav-link" href="#" @click.prevent="redireccionar('DatosAlumno')"> 
                                            <i class="fa fa-address-card  me-3"></i>Datos
                                        </a>
                                    </li>
                                    <li class="mb-1" >
                                        <a class="nav-link" href="#" @click.prevent="redireccionar('MatriculaAlumno')"> 
                                            <i class="fa fa-edit  me-3"></i>Matricula
                                        </a>
                                    </li>
                                    <li class="mb-1" >
                                        <a class="nav-link" href="#" @click.prevent="redireccionar('NotasAlumno')"> 
                                            <i class="fa fa-file-alt  me-3"></i>Notas
                                        </a>
                                    </li>
                                    <li class="mb-1" >
                                        <a class="nav-link" href="#" @click.prevent="redireccionar('AsistenciaAlumno')"> 
