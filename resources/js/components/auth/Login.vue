<template>
    <div class="col-12 login-admin d-flex align-items-center justify-content-center vh-100 " :style="'background-image: url('+$baseUrlVue('img/otros/fondo-login-admin.jpg')+'; background-size: cover;'">
                        ...
                        <div class="card-body pb-0">
                            <div class="">
                                <form class="form" data-vv-scope="form_registro">
                                    ...
                                    <img :src="$baseUrlVue('img/logo/logotipo-version-5.png')"  height="80" class="logo-admin" alt="">
                                    </h4>
                                    <br>
